...
3. **Bonus**: It implements [OpenAI's Swarm](https://github.com/openai/swarm) ⭐ 21,909 | 🐛 35 | 🌐 Python | 📅 2026-04-15 pattern for multi-agent orchestration, but in a model-agnostic way.
...
* Connects to MCP servers including its own [official MCP server](https://github.com/taskade/mcp) ⭐ 164 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-29 with 50+ tools
...
Looking for MCP servers? Check out the [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,486 | 🐛 3,100 | 📅 2026-08-17 repository.
