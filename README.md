...
1. **Bonus**: It implements [OpenAI's Swarm](https://github.com/openai/swarm) ⭐ 21,990 | 🐛 36 | 🌐 Python | 📅 2026-04-15 pattern for multi-agent orchestration, but in a model-agnostic way.
...
* Connects to MCP servers including its own [official MCP server](https://github.com/taskade/mcp) ⭐ 164 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-17 with 50+ tools
...
Looking for MCP servers? Check out the [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,292 | 🐛 2,326 | 📅 2026-09-15 repository.
